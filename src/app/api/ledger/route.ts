...
export async function GET(req: Request) {
  ...
  return csvResponse(
    ...
    [`时间(${TZ_LABEL})`, "客户", "类型", "单号", "运单号", "说明", "操作人", "金额"],
    rows.map((l) => [fmtTime(l.createdAt), l.customerName, LEDGER_TYPE_LABEL[l.type], l.customNo, l.trackingNo, l.note, l.createdBy, l.amount.toFixed(2)]),
  );
}
